...
{
    let mut visited = BTreeSet::<OutPoint>::new();
...
mod test {
    ...
    use super::*;
    use crate::types::*;
    use crate::coin_selection::filter_duplicates;
    ...
    fn get_test_utxos() -> Vec<WeightedUtxo> {
        ...
        let utxo1 = confirmed_utxo(Amount::from_sat(100_000), 1, 1);
        let utxo2 = confirmed_utxo(FEE_AMOUNT - Amount::from_sat(40), 2, 2);
        let utxo3 = confirmed_utxo(Amount::from_sat(200_000), 3, 3);
        ...
        for i in 0..utxos_number {
            res.push(WeightedUtxo {
                ...
                utxo: Utxo {
                    ...
                    chain_position: Some(rng.next_u32()),
                },
            });
        }
        res
